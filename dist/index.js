            ...
            const body = (() => {
                switch (contentType) {
                    ...
                    case "application/x-www-form-urlencoded":
                        if (!requestParams)
                            return;
                        const encodedRequestParams = new url_1.URLSearchParams();
                        Object.keys(requestParams).forEach((key) => encodedRequestParams.append(key, String(requestParams[key])));
                        return encodedRequestParams;
                }
            })();
            const query = Object.entries(Object.assign({ apiKey: this.apiKey }, queryParams))
                .map((e) => e.join("="))
                .join("&");
            const res = yield node_fetch_1.default(`${this.host}${path}?${query}`, {
                method: method,
                body: body,
...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const client = new client_1.default(host, apiKey);
...
class CustomFieldsWithItemsInput extends parameterInput_1.default {
    ...
    toParams(client, issue) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const customFields = yield client.getCustomFields({
...
exports.default = CustomFieldsWithItemsInput;
